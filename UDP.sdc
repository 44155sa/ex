...
rename_clock -name {ext_mem_clk} -source [get_ports {clk_50}] -master_clock {clk_50} [get_pins {rx_pll_m0/pll_inst.clkc[3]}]
rename_clock -name {video_clk} -source [get_ports {clk_50}] -master_clock {clk_50} [get_pins {clk_pll_m0/pll_inst.clkc[3]}]
